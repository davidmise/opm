            ...
            <div class="card">
                <div class="page-title clearfix">
                    ...
                    <div class="title-button-group">
                        <?php echo modal_anchor(get_uri("overland_pm_plugins/modal_form"), "<i data-feather='download' class='icon-16'></i> " . app_lang('install_plugin'), array("class" => "btn btn-default", "title" => app_lang('install_plugin'))); ?>
                    </div>
                </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#plugin-table").appTable({
            source: '<?php echo_uri("overland_pm_plugins/list_data") ?>',
            columns: [
