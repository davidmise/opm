<?php echo form_open(get_uri("overland_pm_plugins/save"), array("id" => "plugin-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix">
    <div class="container-fluid">
        <?php
        echo view("includes/multi_file_uploader", array(
            "upload_url" => get_uri("overland_pm_plugins/upload_file"),
            "validation_url" => get_uri("overland_pm_plugins/validate_plugin_file"),
            "max_files" => 1,
