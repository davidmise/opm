...
<?php } ?>
        ...
        $("#project-table").appTable({
            ...
            columns: [
                ...
                {title: '<?php echo app_lang("department") ?>', "class": "w10p"},
                ...
                {title: '<?php echo app_lang("start_date") ?>', "class": "w10p", "iDataSort": 5},
                {visible: false, searchable: false, order_by: "deadline"},
                {title: '<?php echo app_lang("deadline") ?>', "class": "w10p", "iDataSort": 7},
...
<?php echo $custom_field_headers; ?>,
            ...
            order: [[1, "desc"]],
            printColumns: combineCustomFieldsColumns([0, 1, 2, 3, 4, 6, 8, 9, 10], '<?php echo $custom_field_headers; ?>'),
            xlsColumns: combineCustomFieldsColumns([0, 1, 2, 3, 4, 6, 8, 9, 10], '<?php echo $custom_field_headers; ?>')
        });
    });
</script>