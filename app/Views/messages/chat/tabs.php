    ...
    <div class="box-content">
        <ul class="chat-tab p0 m0 nav nav-tabs box"  data-bs-toggle="ajax-tab" role="tablist">
            ...
            <li class="box-content" id="chat-inbox-tab-button">
                <a role="presentation" href="#" data-bs-toggle="tab" data-bs-target="#chat-inbox-tab"><i data-feather="message-circle" class="icon-16"></i></a>
            </li>

            <?php if ($show_users_list) { ?>
                <li class="box-content" id="chat-users-tab-button">
                    <a role="presentation"  href="<?php echo_uri("messages/users_list/staff"); ?>" data-bs-toggle="tab" data-bs-target="#chat-users-tab"> <i data-feather="user" class="icon-18"></i></a>
                </li>
            <?php } ?>
...
<div class="overland-chat-body long clearfix">
