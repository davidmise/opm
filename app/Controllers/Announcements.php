...
class Announcements extends Security_Controller {
    ...
    function get_sharing_options_view($return_json = false, $model_info = null) {
        ...
        $view_data["options"] = array("all_members", "specific_members_and_teams", "specific_departments", "all_clients", "specific_cg");
    ...
    function get_departments_dropdown() {
        ...
        foreach ($departments as $department) {
            $departments_dropdown[] = array("id" => "dept:" . $department->id, "text" => $department->title);
        }
