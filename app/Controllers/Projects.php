...
class Projects extends Department_Access_Controller {
    ...
    private function _make_row($data, $custom_fields) {
        ...
        if ($data->department_title) {
            ...
            $department_badge = "<span class='badge' style='background-color: $color; color: white;' title='" . app_lang('department') . "'>" . 
                               "<i data-feather='grid' class='icon-12'></i> " . $data->department_title . "</span>";
        }
