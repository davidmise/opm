...
class Team_members extends Security_Controller {
    ...
    private function _make_row($data, $custom_fields) {
        ...
        if ($data->department_title) {
            ...
            $title_text = $is_it_dept && $data->is_admin ? app_lang('department') . ' (Default for Admins)' : app_lang('department');
            
            $department_badge = "<span class='badge' style='background-color: $color; color: white;' title='" . $title_text . "'>" . 
            ...
            $department_badge = "<span class='badge bg-secondary' title='" . app_lang('no_department') . "'>" . 
                               "<i data-feather='grid' class='icon-12'></i> -</span>";
        }
    ...
    function general_info($user_id) {
        ...
        $view_data['user_info'] = $this->Users_model->get_details(array("id" => $user_id))->getRow();
