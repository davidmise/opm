...
class Left_menus extends Security_Controller {
    ...
    function index($type = "default") {
        ...
        if ($type == "user") {
            ...
            return $this->template->render("left_menu/index", $view_data);
        }
    }
    ...
    function prepare_custom_menu_item_data() {
        ...
        $item_array = array("name" => $title, "language_key" => $language_key, "url" => $url, "is_sub_menu" => $is_sub_menu, "icon" => $icon, "open_in_new_tab" => $open_in_new_tab);
