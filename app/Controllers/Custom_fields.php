...
class Custom_fields extends Security_Controller {
    ...
    function save() {
        ...
        $data = array(
            ...
            "show_in_subscription" => $this->request->getPost('show_in_subscription') ? 1 : 0,
            "show_in_estimate" => $this->request->getPost('show_in_estimate') ? 1 : 0,
            "show_in_contract" => $this->request->getPost('show_in_contract') ? 1 : 0,
    ...
    function subscriptions() {
        return $this->template->view('custom_fields/settings/subscriptions');
    }
    ...
    function contracts() {
        return $this->template->view('custom_fields/settings/contracts');
    }

    function proposals() {
        return $this->template->view('custom_fields/settings/proposals');
    }
