...
-- Dumping database structure for overland_pm
CREATE DATABASE IF NOT EXISTS `overland_pm` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `overland_pm`;

-- Dumping structure for table overland_pm.opm_activity_logs
...
-- Dumping structure for table overland_pm.opm_announcements
...
-- Dumping structure for table overland_pm.opm_article_helpful_status
...
-- Dumping structure for table overland_pm.opm_attendance
...
-- Dumping structure for table overland_pm.opm_automation_settings
...
-- Dumping structure for table overland_pm.opm_checklist_groups
...
-- Dumping structure for table overland_pm.opm_checklist_items
...
-- Dumping structure for table overland_pm.opm_checklist_template
...
-- Dumping structure for table overland_pm.opm_ci_sessions
...
-- Dumping structure for table overland_pm.opm_clients
...
-- Dumping structure for table overland_pm.opm_client_groups
...
-- Dumping structure for table overland_pm.opm_client_wallet
...
-- Dumping structure for table overland_pm.opm_company
...
-- Dumping structure for table overland_pm.opm_contracts
...
-- Dumping structure for table overland_pm.opm_contract_items
...
-- Dumping structure for table overland_pm.opm_contract_templates
...
-- Dumping structure for table overland_pm.opm_custom_fields
...
-- Dumping structure for table overland_pm.opm_custom_field_values
...
-- Dumping structure for table overland_pm.opm_custom_widgets
...
-- Dumping structure for table overland_pm.opm_dashboards
...
-- Dumping structure for table overland_pm.opm_departments
...
-- Dumping structure for table overland_pm.opm_department_permissions
...
-- Dumping structure for table overland_pm.opm_email_templates
...
-- Dumping structure for table overland_pm.opm_estimates
...
-- Dumping structure for table overland_pm.opm_estimate_comments
...
-- Dumping structure for table overland_pm.opm_estimate_forms
...
-- Dumping structure for table overland_pm.opm_estimate_items
...
-- Dumping structure for table overland_pm.opm_estimate_requests
...
-- Dumping structure for table overland_pm.opm_events
...
-- Dumping structure for table overland_pm.opm_event_tracker
...
-- Dumping structure for table overland_pm.opm_expenses
...
-- Dumping structure for table overland_pm.opm_expense_categories
...
-- Dumping structure for table overland_pm.opm_e_invoice_templates
...
-- Dumping structure for table overland_pm.opm_file_category
...
-- Dumping structure for table overland_pm.opm_folders
...
-- Dumping structure for table overland_pm.opm_general_files
...
-- Dumping structure for table overland_pm.opm_help_articles
...
-- Dumping structure for table overland_pm.opm_help_categories
...
-- Dumping structure for table overland_pm.opm_invoices
...
-- Dumping structure for table overland_pm.opm_invoice_items
...
-- Dumping structure for table overland_pm.opm_invoice_payments
...
-- Dumping structure for table overland_pm.opm_items
...
-- Dumping structure for table overland_pm.opm_item_categories
...
-- Dumping structure for table overland_pm.opm_labels
...
-- Dumping structure for table overland_pm.opm_lead_source
...
-- Dumping structure for table overland_pm.opm_lead_status
...
-- Dumping structure for table overland_pm.opm_leave_applications
...
-- Dumping structure for table overland_pm.opm_leave_types
...
-- Dumping structure for table overland_pm.opm_likes
...
-- Dumping structure for table overland_pm.opm_messages
...
-- Dumping structure for table overland_pm.opm_milestones
...
-- Dumping structure for table overland_pm.opm_notes
...
-- Dumping structure for table overland_pm.opm_note_category
...
-- Dumping structure for table overland_pm.opm_notifications
...
-- Dumping structure for table overland_pm.opm_notification_settings
...
-- Dumping structure for table overland_pm.opm_orders
...
-- Dumping structure for table overland_pm.opm_order_items
...
-- Dumping structure for table overland_pm.opm_order_status
...
-- Dumping structure for table overland_pm.opm_pages
...
-- Dumping structure for table overland_pm.opm_payment_methods
...
-- Dumping structure for table overland_pm.opm_paypal_ipn
...
-- Dumping structure for table overland_pm.opm_pin_comments
...
-- Dumping structure for table overland_pm.opm_posts
...
-- Dumping structure for table overland_pm.opm_projects
...
-- Dumping structure for table overland_pm.opm_project_comments
...
-- Dumping structure for table overland_pm.opm_project_files
...
-- Dumping structure for table overland_pm.opm_project_members
...
-- Dumping structure for table overland_pm.opm_project_settings
...
-- Dumping structure for table overland_pm.opm_project_status
...
-- Dumping structure for table overland_pm.opm_project_time
...
-- Dumping structure for table overland_pm.opm_proposals
...
-- Dumping structure for table overland_pm.opm_proposal_comments
...
-- Dumping structure for table overland_pm.opm_proposal_items
...
-- Dumping structure for table overland_pm.opm_proposal_templates
...
-- Dumping structure for table overland_pm.opm_reminder_logs
...
-- Dumping structure for table overland_pm.opm_reminder_settings
...
-- Dumping structure for table overland_pm.opm_roles
...
-- Dumping structure for table overland_pm.opm_settings
...
-- Dumping structure for table overland_pm.opm_social_links
...
-- Dumping structure for table overland_pm.opm_stripe_ipn
...
-- Dumping structure for table overland_pm.opm_subscriptions
...
-- Dumping structure for table overland_pm.opm_subscription_items
...
-- Dumping structure for table overland_pm.opm_tasks
...
-- Dumping structure for table overland_pm.opm_task_priority
...
-- Dumping structure for table overland_pm.opm_task_status
...
-- Dumping structure for table overland_pm.opm_taxes
...
-- Dumping structure for table overland_pm.opm_team
...
-- Dumping structure for table overland_pm.opm_team_member_job_info
...
-- Dumping structure for table overland_pm.opm_tickets
...
-- Dumping structure for table overland_pm.opm_ticket_comments
...
-- Dumping structure for table overland_pm.opm_ticket_templates
...
-- Dumping structure for table overland_pm.opm_ticket_types
...
-- Dumping structure for table overland_pm.opm_to_do
...
-- Dumping structure for table overland_pm.opm_users
...
-- Dumping structure for table overland_pm.opm_user_departments
...
-- Dumping structure for table overland_pm.opm_verification
...
-- Dumping structure for table overland_pm.opm_workflow_documents
...
-- Dumping structure for table overland_pm.opm_workflow_shipments
...
-- Dumping structure for table overland_pm.opm_workflow_tasks
...
-- Dumping structure for table overland_pm.opm_workflow_tracking
...
-- Dumping structure for table overland_pm.opm_workflow_trucks
...
-- Dumping structure for table overland_pm.opm_workflow_truck_allocations
