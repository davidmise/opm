...
<html lang="en">
    ...
    <title>O.P.M - Overland Project Manager Installation</title>
        ...
        <div class="install-box">
            ...
            <div class="card card-install">
                <div class="card-header text-center">                    
                    <h2> O.P.M - Overland Project Manager Installation</h2>
                </div>
                <div class="card-body no-padding">
                    ...
                    <div class="tab-content">
                                    ...
                                    <div>
                                        ...
                                        <div class="form-group clearfix">
                                            <div class="row">
                                                ...
                                                <div class=" col-md-9">
                                                    <input id="dbprefix" type="text" value="opm_" name="dbprefix" class="form-control" placeholder="Table Prefix" maxlength="21" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div role="tabpanel" class="tab-pane" id="finished-tab">
                            <div class="section">
                                <div class="clearfix">
                                    <i data-feather="check-circle" height="2.5rem" width="2.5rem" stroke-width="3" class='status mr10'></i><span class="pull-left"  style="line-height: 50px;">Congratulation! You have successfully installed O.P.M - Overland Project Manager.</span>  
                                </div>
